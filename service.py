...
def display(point_file,line_file):
    ...
    ax.axis([0,WI,0,BR])
    plt.savefig("/kubeless/raw_graph.jpg")
    # print(point_remain)
    # print(raw_matrix)
...
def display_again(point_file,line_file):
    ...
    ax.axis([0,WI,0,BR])
    plt.savefig("/kubeless/new_graph.jpg")
    # print(point_remain)
    # print(raw_matrix)
...
def displayroute1(point_file,result,cluster_num):
    ...
    for j in range(len(result)):
        ...
        ax.axis([0,WI,0,BR])
        if os.path.exists("/kubeless/case1/" + str(cluster_num)) == False:
            os.mkdir("/kubeless/case1/" + str(cluster_num))
        plt.savefig("/kubeless/case1/" + str(cluster_num) + "/" + str(j+1) + ".jpg")
...
def displayroute2(point_file,result,cluster_num):
    ...
    for j in range(len(result)):
        ...
        ax.axis([0, WI, 0, BR])
        if os.path.exists("/kubeless/case2" + str(cluster_num)) == False:
            os.mkdir("/kubeless/case2" + str(cluster_num))
        plt.savefig("/kubeless/case2" + str(cluster_num) + "/" + str(j + 1) + ".jpg")
...
def plan_route(start_input,end_input,map_height,num_of_u):
    if map_height == 1:
        ...
        initialize("/kubeless/raw_point.txt", "/kubeless/raw_line.txt", start, end_information)
        display("/kubeless/raw_point.txt", "/kubeless/raw_line.txt")
        preprocess("/kubeless/raw_point.txt", "/kubeless/raw_line.txt", "/kubeless/new_point.txt", "/kubeless/new_line.txt")
        display_again("/kubeless/new_point.txt", "/kubeless/new_line.txt")

        # result = sa("/kubeless/new_point.txt","/kubeless/new_line.txt")
        # display_route("/kubeless/raw_point.txt",result)
        # result1,result2 = multimission("/kubeless/new_point.txt","/kubeless/new_line.txt")
        # display_multi_route("/kubeless/raw_point.txt",result1,result2)
        if num_of_u == 1:
            result1_1 = multiroute1("/kubeless/new_point.txt", "/kubeless/new_line.txt", 1)
            if os.path.exists("/kubeless/case1") == False:
                os.mkdir("/kubeless/case1")
            displayroute1("/kubeless/raw_point.txt", result1_1, 1)
            return result1_1

        elif num_of_u == 2:
            result1_2 = multiroute1("/kubeless/new_point.txt", "/kubeless/new_line.txt", 2)
            if os.path.exists("/kubeless/case1") == False:
                os.mkdir("/kubeless/case1")
            displayroute1("/kubeless/raw_point.txt", result1_2, 2)
            return result1_2

        elif num_of_u == 3:
            result1_3 = multiroute1("/kubeless/new_point.txt", "/kubeless/new_line.txt", 3)
            if os.path.exists("/kubeless/case1") == False:
                os.mkdir("/kubeless/case1")
            displayroute1("/kubeless/raw_point.txt", result1_3, 3)
            return result1_3

        elif num_of_u == 4:
            result1_4 = multiroute1("/kubeless/new_point.txt", "/kubeless/new_line.txt", 4)
            if os.path.exists("/kubeless/case1") == False:
                os.mkdir("/kubeless/case1")
            displayroute1("/kubeless/raw_point.txt", result1_4, 4)
            return result1_4

        else:
            result1_5 = multiroute1("/kubeless/new_point.txt", "/kubeless/new_line.txt", 5)
            if os.path.exists("/kubeless/case1") == False:
                os.mkdir("/kubeless/case1")
            displayroute1("/kubeless/raw_point.txt", result1_5, 5)
            return result1_5

    if map_height == 5:
        f = open("/kubeless/raw_point.txt")
        ...
        f = open("/kubeless/point_2.txt", 'w')
        f.truncate()
        f.close()
        f = open("/kubeless/point_2.txt", 'a')
        for i in range(len(point_remain)):
        ...
        f = open("kubeless/line_2.txt", 'w')
        f.truncate()
        f.close()
        f = open("kubeless/line_2.txt", 'a')
        for i in range(len(point_remain)):
            for j in range(i + 1, len(point_remain)):
        ...
        if num_of_u == 1:
            result2_1 = multiroute2("/kubeless/point_2.txt", "kubeless/line_2.txt", 1)
            if os.path.exists("/kubeless/case2") == False:
                os.mkdir("/kubeless/case2")
            displayroute2("/kubeless/point_2.txt", result2_1, 1)
            return result2_1

        elif num_of_u == 2:
            result2_2 = multiroute2("/kubeless/point_2.txt", "kubeless/line_2.txt", 2)
            if os.path.exists("/kubeless/case2") == False:
                os.mkdir("/kubeless/case2")
            displayroute2("/kubeless/point_2.txt", result2_2, 2)
            return result2_2

        elif num_of_u == 3:
            result2_3 = multiroute2("/kubeless/point_2.txt", "kubeless/line_2.txt", 3)
            if os.path.exists("/kubeless/case2") == False:
                os.mkdir("/kubeless/case2")
            displayroute2("/kubeless/point_2.txt", result2_3, 3)
            return result2_3

        elif num_of_u == 4:
            result2_4 = multiroute2("/kubeless/point_2.txt", "kubeless/line_2.txt", 4)
            if os.path.exists("/kubeless/case2") == False:
                os.mkdir("/kubeless/case2")
            displayroute2("/kubeless/point_2.txt", result2_4, 4)
            return result2_4

        else:
            result2_5 = multiroute2("/kubeless/point_2.txt", "kubeless/line_2.txt", 5)
            if os.path.exists("/kubeless/case2") == False:
                os.mkdir("/kubeless/case2")
            displayroute2("/kubeless/point_2.txt", result2_5, 5)
            return result2_5
...
def handle(event, context):
    ...
    start_point = str(data['pointInformation']['start'])
    pass_point = list(data['pointInformation']['pass'])
    height = int(data['heightInformation']['h'])
    num = int(data['flightInformation']['num'])
    result = plan_route(start_point, pass_point, height, num)
...
if __name__ == '__main__':
    ...
    input = '{"start_point": "10", "pass_point": ["20","30","40"], "height": 1, "num": 1}'
    data = json.loads(input)
    start_point = data['start_point']
    pass_point = data['pass_point']
    height = data['height']
    num = data['num']
    result = plan_route(start_point, pass_point, height, num)
    print("result\n")
